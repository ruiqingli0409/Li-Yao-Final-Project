...
3. **[DESCRIPTIVE STATISTICS](#paragraph2)**
    ...
    3.3 [EXPLORATORY ANALYSIS](#subparagraph7)
    
    3.4 [ANALYSIS & VISUALIZATIONS](#subparagraph8)
    
4. **[SUMMARY and RESULTS](#paragraph3)**

5. **[DISCUSSION](#paragraph4)**

    5.1 [Conclusion](#subparagraph9)
    
    5.2 [Limitations](#subparagraph10)
...
##### EXPLORATORY ANALYSIS <a name="subparagraph7"></a>
...
##### ANALYSIS & VISUALIZATIONS <a name="subparagraph8"></a>
```{r}
...
plot(new.model.wfh)
```
#### **SUMMARY and RESULTS** <a name="paragraph3"></a>
...
##### Limitations <a name="subparagraph10"></a>
